            ...
            <div class="modal-dialog">
              <div class="modal-content1">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel"> {t('log_in')} </h5>
                ...
                <div class="modal-body">
                  <div class="dropdowns">
                    <form class="px-4 py-3">
                      <div class="mb-3">
                        <label for="exampleDropdownFormEmail1" class="form-label">{t('Email')}</label>
                      ...
                      <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="exampleDropdownFormPassword1" placeholder="t('password')" />
                      </div>
                      <div class="mb-3">
